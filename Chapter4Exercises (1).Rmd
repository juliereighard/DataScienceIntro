...
```{r}
summarize(group_by(mycars,cyl),avgmpg=mean(mpg))
```
...
```
the car with the highest powerspeed is the maserati bora, and the car with the least powerspeed is the honda civic
